...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public CustomExpandableListAdapter(View view, Context context, List<String> expandableListTitle,
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        int imageResourceId = isExpanded ? R.drawable.ic_expand
